...
export function Markdown({ children }: { children: string }) {
  return (
    <ReactMarkdown
      ...
      components={{
        h1: (p) => <h1 className="mb-1 mt-2 text-base font-bold first:mt-0" {...p} />,
        h2: (p) => <h2 className="mb-1 mt-2 text-[15px] font-bold first:mt-0" {...p} />,
        ...
        hr: () => <hr className="my-3 border-[#e0eef5]" />,
        blockquote: (p) => (
          <blockquote className="my-2 border-l-2 border-[#bcd7e3] pl-3 text-[#3f6f81]" {...p} />
        ),
        table: (p) => (
